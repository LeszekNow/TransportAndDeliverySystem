...
public class Motorcycle extends Car {
    ...
    public Motorcycle(String brand, String model, String colour, int mileage, int engineCapacity,
                      double fuelConsumption, String vin, String registrationNumber, int maxPackageWeight, VehicleType vehicleType, boolean arrested) {
    ...
    public Motorcycle(int id, String brand, String model, String colour, int mileage, int engineCapacity,
                      double fuelConsumption, String vin, String registrationNumber, int maxPackageWeight, VehicleType vehicleType, boolean arrested, String inspectionDate) {
