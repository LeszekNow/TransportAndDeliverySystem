...
public class PackageOrderDataController {
    ...
    public void createOrder() throws Exception {
        ...
        if (adjustedVehicle == 0 || adjustedDriver == 0) {
            ...
            String customerType = dbHandler.getStringFromDB("SELECT customerType FROM tclient WHERE username = '" + username.getText() + "';", "customerType");
    ...
    public void getBack() throws Exception {
        ((Stage) submit.getScene().getWindow()).setScene(controllersHelper.loadFXMLScreen("CustomerMainMenuScreen.fxml"));
    }
